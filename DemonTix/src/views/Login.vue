    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <button class="btn transparent" @click="isSignUpMode = true">Sign Up</button>
        </div>
      ...
      <div class="panel right-panel">
        <div class="content">
          ...
          <button class="btn transparent" @click="isSignUpMode = false">Sign In</button>
        </div>
        <img src="../assets/logo.png" class="image" alt="" />
      </div>
    </div>
  ...
  methods: {
    handleLogin() {
      ...
      if (username === "admin" && password === "admin123") {
        ...
        this.$router.push("/home"); // Pastikan routing ke /home sudah diatur
      } else {
        alert("Username atau password salah.");
      }
    },
    handleSignUp() {
      // Untuk demonstrasi, hanya tampilkan data
      console.log("Sign Up Data:", this.signUpForm);
      alert("Sign Up berhasil (simulasi)!");
...
.container:before {
  ...
  background-image: linear-gradient(-45deg, #A43434 0%, #A43434 100%);
...
.left-panel {
  pointer-events: all;
  padding: 3rem 17% 15rem 12%;
}

.right-panel {
  pointer-events: none;
  padding: 3rem 12% 15rem 17%;
}
...
.btn.transparent {
    margin: 20px 0 0 0; /* Tambah jarak atas 20px */
    background: none;
